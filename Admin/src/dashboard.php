...
<body>
    <div class="container">
        <h4 class="text-center fw-bold mt-2">Welcome Admin</h4>

        <div class="container px-lg-5">
            <h5 class="text-black-50 mt-4">Overview this Month</h5>
            <hr>
            <div class="row row-cols-2 row-cols-md-3 gx-lg-5 gy-3 overviews">
                <div class="col">
                    <div class="card h-100  shadow text-white rounded-4 shortcuts" id="houses" onclick="ShowProperties()">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-evenly">
                                <img src="./Admin/assets/Neighborhood.png" alt="">
                ...
                <div class="col">
                    <div class="card h-100 shadow  text-white rounded-4 shortcuts" id="tenants" onclick="ShowTenants()">
                        <div class="card-body ">
                            <div class="d-flex align-items-center justify-content-evenly">
                                <img src="./Admin/assets/Tenant.png" alt="">
                                <div class="d-flex flex-column align-items-center">
                ...
                <div class="col">
                    <div class="card  h-100 shadow text-white  rounded-4 shortcuts" id="payments" onclick="ShowPayments()">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-evenly">
                                <img src="./Admin/assets/Online Payment.png" alt="">
                                <div class="d-flex flex-column align-items-center">
